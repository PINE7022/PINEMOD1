...
public class RaiModel<T extends RaiEntity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(56, 12).addBox(-3.0F, -16.0F, -1.0F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(66, 41).addBox(-4.0F, -16.0F, -2.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(14, 65).addBox(-4.0F, -17.0F, -1.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(40, 64).addBox(2.0F, -16.0F, -2.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(60, 63).addBox(2.0F, -17.0F, -1.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(54, 22).addBox(-3.0F, -19.0F, 0.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(66, 48).addBox(-2.0F, -20.0F, 2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 24.0F, 0.0F));
        ...
        PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(28, 71).addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(66, 70).addBox(4.0F, -2.0F, -1.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -18.0F, 5.0F, -0.3927F, 0.0F, 0.0F));

        PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(30, 0).addBox(-1.0F, -1.0F, -1.0F, 4.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6073F, -17.2544F, -5.0F, 0.0F, 0.0F, -0.6109F));

        PartDefinition cube_r9 = head.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 30).addBox(-1.0F, -1.0F, -1.0F, 4.0F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.031F, -18.4016F, -5.0F, 0.0F, 0.0F, 0.6109F));

        PartDefinition cube_r10 = head.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 15).addBox(0.0F, -1.0F, -11.0F, 1.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -17.0F, 0.0F, 0.0F, 0.0F, 0.7854F));

        PartDefinition cube_r11 = head.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -1.0F, -11.0F, 1.0F, 1.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -17.0F, 0.0F, 0.0F, 0.0F, 0.7854F));
